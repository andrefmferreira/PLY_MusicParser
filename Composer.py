...
def do_pause(action, parser):  # TODO: CHECK DURATION OF PAUSE WITH PROFESSOR ALBERTO
    # duration = int(parser.cDur / 1) * action.args['val']
    duration = parser.cDur * action.args['val']
    parser.notes.append([0, duration])


# function to merge notes
def do_merge(action, parser):  # WIP TODO: fixme
    val = action.args['val']
